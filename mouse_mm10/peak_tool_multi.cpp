...
int main (int argc, char *argv[]){  
  ...
  string enhancerFileName="/home/amitra/proj/abhishekNGS/huge_files/mouse/enhancers/enhancers-mm10.bed";
  int ret;
  ret=load_enhancers(enhancerBitmaps,enhancerFileName);
  if (ret==0){
    enhancerFileName="enhancers-mm10.bed";
    ret=load_enhancers(enhancerBitmaps,enhancerFileName);
  }
 
  vector<feature_bitmaps> superenhancerBitmaps;
  string superenhancerFileName="/home/amitra/proj/abhishekNGS/huge_files/mouse/enhancers/super-enhancers-mm10.bed";
  ...
  if(argc<2){
    cerr << endl << "peak_tool_multi <peak file primary> <optional: peak file 2>...<optional: peak file n>"<<endl;;
    return 0;
  }
  ...
  string gencodeFileName="/home/amitra/proj/abhishekNGS/huge_files/mouse/gencode/gencode.vM4.annotation.gtf";
  ...
  if(ret==0){
    gencodeFileName="gencode.vM4.annotation.gtf";
    ret=read_gencode_annotation_file(exonBitmaps, promoterMapsW, promoterMapsC, transcriptMaps, \
				genesData, transcriptsData, exonsData, gencodeFileName);
  }
  if(ret==0){
